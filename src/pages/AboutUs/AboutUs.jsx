...
const AboutUs = () => {
  ...
  return (
    ...
    <ul className="abt-us-sidebar-menu" style={{display:showLinks?"flex":"none"}}>
        ...
        <li><Link to='/about-us' className='abt-us-navbar-menu-link-sidebar' onClick={()=>setShowLinks(false)}>About Us</Link></li>
        <li><Link to='/services' className='abt-us-navbar-menu-link-sidebar' onClick={()=>setShowLinks(false)}>Services</Link></li>
        ...
        <li><Link to='/contact-us' className='abt-us-navbar-menu-link-sidebar' onClick={()=>setShowLinks(false)}>Contact Us</Link></li>
        </ul>
